...
const Header = () => {
  ...
  return (
    ...
    <div className='header-section'>
      <img src={logo} alt="Fiverr" style={{width: '100px', height: '50px', cursor: "pointer"}} onClick={() => {navigate('/dashboard')}}/>
